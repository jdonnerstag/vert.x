 ...
 * under the License.
 */
package org.vertx.java.core.timer;
 ...
 */
public interface Timer<T extends Timeout> {
	 ...
	 */
	T newTimeout(TimerTask task, long delay, TimeUnit unit, boolean periodic);
