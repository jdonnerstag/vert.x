...
abstract class AbstractNioWorker implements Worker {
    ...
    protected long getWaitTimeout(long timeout) {
    	return timeout;
    }
    ...
    public void run() {
        ...
        for (;;) {
            ...
            try {
                ...
                int selected = SelectorUtil.select(selector, getWaitTimeout(SelectorUtil.SELECT_TIMEOUT));
    ...
    /**
     * Subclass to provide you own implementation
     */
